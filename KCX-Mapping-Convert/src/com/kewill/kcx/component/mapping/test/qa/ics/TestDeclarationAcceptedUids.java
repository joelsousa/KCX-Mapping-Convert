...
/**
 * Module		: TestDeclarationAcceptedUids<br>
 * Date Created	: July 19, 2010<br>
 * Description	: Conversion of a DeclarationAccepted
...
public class TestDeclarationAcceptedUids extends TestUidsToUidsFromCustomer {
	
	public TestDeclarationAcceptedUids(String name) {
		super(name);
		Utils.log(
			"(TestDeclarationAcceptedUids TestDeclarationAcceptedUids) name = " + name);
	}
	...
	protected void runDiff(boolean split) {
        ...
        //Expected differences using ICSDeclarationAccepted.xml
