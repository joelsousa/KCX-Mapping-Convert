 ...
 * @version 1.0.00
 */
public class TestExportDeclarationKidsToKids extends TestKidsToKcxFromCustomer {

    public TestExportDeclarationKidsToKids(String name) {
        super(name);
        Utils.log("(TestExportDeclarationKidsToKids TestExportDeclarationKidsToKids) name = " + name);
    }

    protected void setFileNames() {
        inputFileName       = "UK_HJH_TST_2010622_0001.xml";
        referenceFileName   = "UK_HJH_TST_2010622_0001.xml";
    }
