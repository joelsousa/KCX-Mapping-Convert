...
/**
 * Module		: TestEntryReleaseUids<br>
 * Date Created	: July 19, 2010<br>
 * Description	: Conversion of a EntryRelease
...
public class TestEntryReleaseUids extends TestUidsToUidsFromCustomer {
	
	public TestEntryReleaseUids(String name) {
		super(name);
		Utils.log(
			"(TestEntryReleaseUids TestEntryReleaseUids) name = " + name);
	}
	
	protected void setInputFileName() {
		inputFileName 	= "ICSEntryRelease.xml";
		encoding		= "UTF-8";
	}
	protected void runDiff(boolean split) {
        ArrayList<Difference> expected = new ArrayList<Difference>();
        
        //Expected differences using ICSEntryRelease.xml
