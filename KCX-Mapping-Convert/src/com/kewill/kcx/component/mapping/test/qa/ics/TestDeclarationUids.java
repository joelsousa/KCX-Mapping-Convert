...
/**
 * Module		: TestDeclarationUids<br>
 * Date Created	: July 19, 2010<br>
 * Description	: Conversion of a Declaration
...
public class TestDeclarationUids extends TestUidsToUidsFromCustomer {
	
	public TestDeclarationUids(String name) {
		super(name);
		Utils.log(
			"(TestDeclarationUids TestDeclarationUids) name = " + name);
	}
	
	protected void setInputFileName() {
		inputFileName 	= "ICSDeclaration.xml";
		encoding		= "UTF-8";
	}
	protected void runDiff(boolean split) {
        ArrayList<Difference> expected = new ArrayList<Difference>();
        
        //Expected differences using ICSDeclaration.xml
