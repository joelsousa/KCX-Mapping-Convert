package com.kewill.kcx.component.mapping.test.mains.mt;
 ...
 * @version 1.0.00
 */
public final class MtToKidsICSTestMain {
    
    private MtToKidsICSTestMain() { }
    
	public static void main(String[] args) {
				
		MaltaToKidsMule maltaToKids = new MaltaToKidsMule();
        ...
        try {
        	...
        	xml = maltaToKids.readMalta(parser, "TestAuditId", "UTF-8", EDirections.CustomerToCountry);
