...
/**
 * Modul		: TestKidsToBdecFromCustomer<br>
 * Erstellt		: 17.05.2010<br>
 * Beschreibung	: Convert KIDS message to KIDS to BDEC. 
 * 
 * @author schmidt
 * @version 1.0.00
 */
public abstract class TestKidsToBdecFromCustomer extends TestOneWay {

    public TestKidsToBdecFromCustomer(String name) {
        super(name);
        Utils.log("(TestKidsToBdecFromCustomer TestKidsToBdecFromCustomer) name = " + name);
    }
