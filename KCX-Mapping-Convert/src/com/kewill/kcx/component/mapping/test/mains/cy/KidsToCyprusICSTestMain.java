...
import com.kewill.kcx.component.mapping.common.start.customs.out.KidsToCyprusMule;
...
public class KidsToCyprusICSTestMain  {
		
	public static void main(String[] args) {
		
		KidsToCyprusMule  kidsToCyprusMule = new KidsToCyprusMule();
		
		
		//String payload = getMessage();
		String payload = getFileMessage(args[0]);
    	Utils.log("Cyprus message : " + payload);
        ...
        try {
        	...
        	Object xml = kidsToCyprusMule.readKids(parser, "UTF-8", "testfile", EDirections.CountryToCustomer);
