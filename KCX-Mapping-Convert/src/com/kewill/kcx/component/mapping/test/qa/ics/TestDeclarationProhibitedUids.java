...
/**
 * Module		: TestDeclarationProhibitedUids<br>
 * Date Created	: July 19, 2010<br>
 * Description	: Conversion of a DeclarationProhibited
...
public class TestDeclarationProhibitedUids extends TestUidsToUidsFromCustomer {
	
	public TestDeclarationProhibitedUids(String name) {
		super(name);
		Utils.log(
			"(TestDeclarationProhibitedUids TestDeclarationProhibitedUids) name = " + name);
	}
	
	protected void setInputFileName() {
		inputFileName 	= "ICSDeclarationProhibited.xml";
		encoding		= "UTF-8";
	}
	protected void runDiff(boolean split) {
        ArrayList<Difference> expected = new ArrayList<Difference>();
        
        //Expected differences using ICSDeclarationProhibited.xml
