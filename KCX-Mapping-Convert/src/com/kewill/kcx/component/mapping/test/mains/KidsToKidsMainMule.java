...
public class KidsToKidsMainMule {
	...
	public static void main(String[] args) {
        ...
        try {
    		...
    		//xml = kidsTokids.readKids(parser, "UTF-8", "testfile", EDirections.CustomerToCountry);  
    		xml = kidsTokids.readKids(parser, "UTF-8", "testfile", EDirections.CountryToCustomer);  	        		
