...
/**
 * Modul        : TestConfirmUids<br>
 * Erstellt     : 14.12.2008<br>
 * Description  : Conversion of a Confirm message 
 ...
 * @version 1.0.00
 */
public class TestConfirmUids extends TestUidsToUidsFromCustomer {

    public TestConfirmUids(String name) {
        super(name);
        Utils.log("(TestConfirmUids TestConfirmUids) name = " + name);
    }

    protected void setInputFileName() {
        inputFileName  = "DE01DE01215820080923121300037.xml";
    }
