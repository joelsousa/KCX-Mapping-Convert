 ...
 * @version 1.0.00
 */
public abstract class TestKidsToKcxFromCountry extends TestOneWay {

    public TestKidsToKcxFromCountry(String name) {
        super(name);
        Utils.log("(TestKidsToKcxFromCountry TestKidsToKcxFromCountry) name = " + name);
    }
