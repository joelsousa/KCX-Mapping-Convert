...
/*
 * Function    : KidsToMaltaICSTestMain
 * Titel       :
 * Date        : 21.08.2013
 * Author      : Alfred Krzoska
 * Description : TestMain for ICS conversion of Kids messages to Malta messages
 * 			   : 
 */
...
public class KidsToMaltaICSTestMain  {
		
	public static void main(String[] args) {
		
    KidsToMaltaMule  kidsToMaltaMule  = new KidsToMaltaMule();
    ...
    try {
    	...
    	Object xml = kidsToMaltaMule.readKids(parser, "UTF-8", "testfile", EDirections.CountryToCustomer);
