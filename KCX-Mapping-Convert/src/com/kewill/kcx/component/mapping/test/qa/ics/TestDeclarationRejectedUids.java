...
/**
 * Module		: TestDeclarationRejectedUids<br>
 * Date Created	: July 19, 2010<br>
 * Description	: Conversion of a DeclarationRejected
...
public class TestDeclarationRejectedUids extends TestUidsToUidsFromCustomer {
	
	public TestDeclarationRejectedUids(String name) {
		super(name);
		Utils.log(
			"(TestDeclarationRejectedUids TestDeclarationRejectedUids) name = " + name);
	}
	
	protected void setInputFileName() {
		inputFileName 	= "ICSDeclarationRejected.xml";
		encoding		= "UTF-8";
	}
	protected void runDiff(boolean split) {
        ArrayList<Difference> expected = new ArrayList<Difference>();
        
        //Expected differences using ICSDeclarationRejected.xml
