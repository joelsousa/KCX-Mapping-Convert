 ...
 * @version 1.0.00
 */
public class TestKidsToUids extends TestKidsToUidsFromCountry {

    public TestKidsToUids(String name) {
        super(name);
        Utils.log("(TestKidsToUids TestKidsToKids) name = " + name);
    }

    protected void setFileNames() {
        inputFileName       = "INFORM-1281442987044-18.xml";
        // inputFileName       = "EMCSEventReport.xml";
        inputFileName       = "EMCSValidDeclaration.xml";
