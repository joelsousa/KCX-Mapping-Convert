...
/*
 * Function    : UidsToKidsTESEPDAT.java
 * Titel       :
 * Date        : 07.10.2008
...
public class UidsToKidsTESTEXPDAT {
	...
	public static void main(String[] args) {
    	...
    	Utils.log("uidsConfirmationMessage : " + payload);
        ...
        Utils.log("(UidsToKidsTESTEXPDAT main) Converted Message = \n" + xml);
	}
