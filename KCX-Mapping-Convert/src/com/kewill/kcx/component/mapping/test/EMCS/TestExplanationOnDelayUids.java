 ...
 * Description	: Conversion of a EMCSExplanationOnDelay 
 *                from UIDS to KIDS .
 *                SampleEMCSExplanationOnDelay.xml and SampleEMCSExplanationOnDelay_reference.xml must be identical. 
 * 
 * @author krzoska
 * @version 1.0.00
 */
public class TestExplanationOnDelayUids extends TestUidsToKidsFromCustomer {
    
    public TestExplanationOnDelayUids(String name) {
        super(name);
        Utils.log("(TestExplanationOnDelayUids TestExplanationOnDelayUids) name = " + name);
    }

    protected void setFileNames() {
    	inputFileName  = "SampleEMCSExplanationOnDelay.xml";
    	referenceFileName = "SampleEMCSExplanationOnDelay_reference.xml";
        encoding = "UTF-8";
    }
