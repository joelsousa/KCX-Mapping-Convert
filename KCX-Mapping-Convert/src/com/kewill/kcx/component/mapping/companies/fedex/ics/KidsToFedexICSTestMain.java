...
import com.kewill.kcx.component.mapping.common.start.customer.out.KidsToFedexMule;
 ...
 *  @version 1.0.00
 */
public class KidsToFedexICSTestMain {

	public static void main(String[] args) {
		
		KidsToFedexMule kidsToFedex = new KidsToFedexMule();
        ...
        try {
    		...
    		xml = kidsToFedex.readKids(parser, "UTF-8", "testfile", 
