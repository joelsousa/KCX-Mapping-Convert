...
public class UnisysToKidsICSTestMain {

	public static void main(String[] args) {
		
		//FedexToKidsICS fedexToKids = new FedexToKidsICS();
		UnisysToKidsMule unisysToKids = new UnisysToKidsMule();
        ...
        try {
        	...
        	xml = unisysToKids.readUnisys(parser, "TestAuditId", "UTF-8", EDirections.CustomerToCountry);
	...
	public static void main_alt(String[] args) {
		...
		UnisysHeader unisysHeader; 
		CommonFieldsDTO commonFieldsDTO;
		
		//String payload = getMessage();
		String payload = getFileMessage(args[0]);
    	Utils.log("unisys payload : " + payload);
        ...
        try {
			...
			xml = unisysToKidsICS.readUnisys(parser, "UTF-8", unisysHeader, commonFieldsDTO);
		} catch (Exception e) {
			e.printStackTrace();
		}
