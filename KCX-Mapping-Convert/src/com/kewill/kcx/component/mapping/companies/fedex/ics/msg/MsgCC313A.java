...
public class MsgCC313A extends KCXMessage {
	...
	private MsgCC313APos goodsItem;
	private List <MsgCC313APos>goodsItemList;
	...
	protected enum ECC313A {
		EnveloppeMessage, Messages,Message, MessageBody, MessageOperateur,
		DatOfPreMES9, TimOfPreMES10, MesTypMES20, NADLNGCO, NADLNGCE, CC313A,
		MesSenMES3,
		MesRecMES6,
		HEAHEA,
		TRACONCO1,
	...
	public void startElement(Enum tag, String value, Attributes attr) {
		if (value == null) {
			...
			case GOOITEGDS:	goodsItem = new MsgCC313APos(getScanner());
	...
	private void addGoodsItemList(MsgCC313APos goodsItem) {
		if (goodsItemList == null) {
            goodsItemList = new Vector<MsgCC313APos>();
		}
	...
	public List<MsgCC313APos> getGoodsItemList() {
