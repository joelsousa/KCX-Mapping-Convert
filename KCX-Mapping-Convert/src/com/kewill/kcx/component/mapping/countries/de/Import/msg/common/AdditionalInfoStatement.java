 ...
 * Description	: will replace AdditionalInformation as String
 * 
 * @author iwaniuk
 * @version 1.0.00
 */
public class AdditionalInfoStatement extends KCXMessage {
    ...
    public AdditionalInfoStatement() {
    	super();    		
    }
    
    public AdditionalInfoStatement(XmlMsgScanner scanner) {
  		super(scanner);
  	}
	...
	public boolean isEmpty() {
		return (Utils.isStringEmpty(text) && Utils.isStringEmpty(code) && Utils.isStringEmpty(type)); 		      
