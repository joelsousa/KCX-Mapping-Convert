...
import com.kewill.kcx.component.mapping.countries.de.aes.kids2kids.MapExitPresentationKK;
...
import com.kewill.kcx.component.mapping.countries.de.aes.kids2kids.MapExpDatKK;
...
import com.kewill.kcx.component.mapping.countries.de.aes.kids2kids.MapExpFupKK;
...
import com.kewill.kcx.component.mapping.countries.de.aes.kids2kids.MapExpRelKK;
import com.kewill.kcx.component.mapping.countries.de.aes.kids2kids.MapExpStaKK;
		...
		switch (EKidsMessages.valueOf(msg)) {
    		...
    		case ReverseDeclaration:
    			...
    			if (kidsHeader.getCountryCode().equalsIgnoreCase("CH")) {
    				...
    				mapCHReverseDeclarationKK.setCommonFieldsDTO(commonFieldsDTO);  //EI20120723
