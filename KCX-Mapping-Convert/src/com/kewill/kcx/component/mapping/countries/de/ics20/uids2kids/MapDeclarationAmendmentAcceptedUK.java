 ...
 * Description	: Mapping of UIDS-ICSDeclarationAmendmentAccepted to KIDS-EntrySummaryDeclarationAmendmentAcceptance.
 * 				: (IE304)
 * 
 * @author iwaniuk
 * @version 2.0.00
...
public class MapDeclarationAmendmentAcceptedUK extends KidsMessage {
	...
	private MsgEntrySummaryDeclarationAmendmentAcceptance message;
		...
		public MapDeclarationAmendmentAcceptedUK(XMLEventReader parser, KidsHeader kidsHeader, String encoding) 
									throws XMLStreamException {
			message	= new MsgEntrySummaryDeclarationAmendmentAcceptance(parser, "UIDS");
