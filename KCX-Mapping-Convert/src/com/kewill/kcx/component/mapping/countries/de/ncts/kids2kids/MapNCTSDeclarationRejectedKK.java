...
/**
 * Module		: MapNCTSDeclarationRejectedKK<br>
 * Created		: 08.25.2010<br>
 * Description	: Mapping of KIDS-Format into KIDS-Format of NCTSDeclarationRejected message. 
 * 
 * @author Lassiter Caviles
 * @version 1.0.00
 */
public class MapNCTSDeclarationRejectedKK extends KidsMessageNCTS {
	
	private BodyNCTSDeclarationRejectedKids body;
	private MsgNCTSDeclarationRejected message;
	
	public MapNCTSDeclarationRejectedKK(XMLEventReader parser, String encoding) throws XMLStreamException {
	...
	public String getMessage() {
        ...
        try {
            ...
            Utils.log("NCTS NCTSDeclarationRejected KidsMessage = " + xmlOutputString.toString());
