...
import com.kewill.kcx.component.mapping.countries.de.suma70.uids2kids.MapNotificationOfPresentationUK;
import com.kewill.kcx.component.mapping.countries.de.suma70.uids2kids.MapNotificationOfPresentationConfirmedUK;
 ...
 * @version 2.0.00
 */
public class UidsToKidsManifest20 {
	...
	public String readUids(XMLEventReader parser, String encoding, 
        ...
        switch(EUidsManifestMessages.valueOf(msg)) {
	        ...
	        case NotificationOfPresentationConfirmed:
	        	MapNotificationOfPresentationConfirmedUK mapNotificationOfPresentationConfirmedUK = 
	        		new MapNotificationOfPresentationConfirmedUK(parser, kidsHeader, encoding);
	    		prepareMessage(uidsHeader, kidsHeader, mapNotificationOfPresentationConfirmedUK, 
	    			commonFieldsDTO, "NotificationOfPresentationConfirmed", direction);
	    		mapNotificationOfPresentationConfirmedUK.getMessage(writer);
	    		break;	    			    
