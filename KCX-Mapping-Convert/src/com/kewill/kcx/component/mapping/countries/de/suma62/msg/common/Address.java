...
public class Address extends KCXMessage {
    ...
    private String district;			//AK21.11.2012
    private String poBox;				//AK21.11.2012
	...
	public boolean isEmpty() {
		return (Utils.isStringEmpty(this.streetAndNumber) && Utils.isStringEmpty(this.name) && 
				...
				Utils.isStringEmpty(postalCode) && Utils.isStringEmpty(poBox));   //AK21.11.2012 
	}
	
	public void setEVP(TsEVP evp) {
		if (evp == null) {
			return;
		}
		this.setName(evp.getName());
		this.setStreetAndNumber(evp.getStr());
		this.setPostalCode(evp.getPlz());
		this.setCity(evp.getOrt());
		this.setCountryCodeISO(evp.getLdkz());
	}
