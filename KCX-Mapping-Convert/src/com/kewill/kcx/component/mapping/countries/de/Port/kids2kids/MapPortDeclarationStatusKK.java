...
/**
 * Modul		: PORT.<br>
 * Erstellt		: 11.04.2012<br>
 * Beschreibung	: Mapping of KIDS-Format into KIDS-Format of PortDeclaration.java message.
 *
 * @author  iwaniuk
 * @version 1.0.00
 */
public class MapPortDeclarationStatusKK extends KidsMessage {

    private BodyPortDeclarationStatusKids body;
    private MsgPortDeclarationStatus 		message;

	public MapPortDeclarationStatusKK(XMLEventReader parser, String encoding) throws XMLStreamException {
		message = new MsgPortDeclarationStatus(parser);
	...
	public String getMessage() {
        ...
        try {
            ...
            body = new BodyPortDeclarationStatusKids(writer);
