package com.kewill.kcx.component.mapping.countries.de.Port.fss2kids;
...
public class MapBZRtoResponse extends KidsMessage {
	...
	public String getMessage() {
	    ...
	    try {
	        ...
	        getCommonFieldsDTO().setReferenceNumber(msgBZR.getAkoSubset().getBeznr());   //EI20120427
	        header.setCommonFieldsDTO(commonFieldsDTO);

	        boolean isErr = true;    //EI20130604
	        String art = "";
	        if (msgBZR.getAkoSubset() != null && !Utils.isStringEmpty(msgBZR.getAkoSubset().getArt())) {    //EI20130604	        	
	        ...
	        //EI20130604: if (msgBZR.getAfeSubsetList() == null && msgBZR.getAkoSubset() != null && !Utils.isStringEmpty(msgBZR.getAkoSubset().getRegnr())) { //EI20120427
	        if (msgBZR.getAfeSubsetList() == null && msgBZR.getAkoSubset() != null && !isErr) {  //EI20130604
	        	if (art.equalsIgnoreCase("AP")) {   //EI20130604	        		  
	        		...
	        		/*
	        		header.setMessageName("PortDeclarationTerminal");
	        		header.writeHeader();
	        		this.setMsgTerminalFields(); 
	        	
	        		BodyPortDeclarationTerminalKids body   = new BodyPortDeclarationTerminalKids(writer);
	        		body.setMessage(terminalMessage);
	        		body.writeBody();
	        		*/
	        		//oder so:
	...
	public void setMsgRegistrationFields() {	
		...
		if (msgBZR.getAkoSubset() != null) {
			...
			// msgBZR.getAkoSubset().getArt() = "AP"  //EDIFACT-Begriff 
