...
import com.kewill.kcx.component.mapping.formats.kids.ics20.BodyEntryReleaseKids;
 ...
 * Description	: Mapping of KIDS-Format into KIDS-Format of ICSEntryRelease IE330 message.
 *
 * @author  iwaniuk
 * @version 2.0.00
 */
public class MapEntryReleaseKK extends KidsMessage {
	...
	public MapEntryReleaseKK(XMLEventReader parser, String encoding) throws XMLStreamException {
		message = new MsgEntryRelease(parser, "KIDS");
	...
	public String getMessage() {
        ...
        try {
            ...
            Utils.log("ICS EntryRelease kids2kids = " + xmlOutputString.toString());
