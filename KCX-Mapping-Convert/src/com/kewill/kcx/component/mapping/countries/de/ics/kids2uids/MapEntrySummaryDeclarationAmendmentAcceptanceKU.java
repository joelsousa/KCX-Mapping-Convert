...
import com.kewill.kcx.component.mapping.formats.uids.ics.BodyEntrySummaryDeclarationAmendmentAcceptanceUids;
import com.kewill.kcx.component.mapping.util.Utils;
import com.kewill.kcx.component.mapping.xml.XmlMsgScanner.HeaderType;


/**
 * Module		: MapEntrySummaryDeclarationAcceptance<br>
 * Date Finished: July 16, 2010<br>
 * Description: Mapping of KIDS-Format into UIDS-Format of EntrySummaryDeclarationAcceptanceKU message.
 * 
...
public class MapEntrySummaryDeclarationAmendmentAcceptanceKU extends UidsMessage {
	...
	public String getMessage() {
        ...
        try {
            ...
            Utils.log("ICS BodyEntrySummaryDeclarationAcceptance UidsMessage = " + xmlOutputString.toString());
