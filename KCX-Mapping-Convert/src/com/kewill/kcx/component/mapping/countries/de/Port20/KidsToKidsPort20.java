...
import com.kewill.kcx.component.mapping.countries.de.Port20.kids2kids.MapPortDeclarationKK;
    ...
    public String readKids(XMLEventReader parser, KidsHeader kidsHeader, CommonFieldsDTO commonFieldsDTO, 
        ...
        switch (EKidsPortMessages.valueOf(msg)) {
        	...
        	case PortDeclaration:
    			...
    			xml = mapPortDeclarationKK.getMessage(isBDP); //EI20130508        		
    			break;
