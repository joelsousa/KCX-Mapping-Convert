 ...
 * Description	: Mapping of UIDS-ICSDeclarationAccepted to KIDS-ICSEntrySummaryDeclarationAcknowledgment.
 * 				: (IE328)
 * 
 * @author iwaniuk
 * @version 2.0.00
...
public class MapDeclarationAcceptedUK extends KidsMessage {

    private BodyEntrySummaryDeclarationAcknowledgmentKids    body;
    private MsgEntrySummaryDeclarationAcknowledgment 		message;

	public MapDeclarationAcceptedUK(XMLEventReader parser, KidsHeader kidsHeader, String encoding) 
	                                                                                        throws XMLStreamException {
		message = new MsgEntrySummaryDeclarationAcknowledgment(parser, "UIDS");
