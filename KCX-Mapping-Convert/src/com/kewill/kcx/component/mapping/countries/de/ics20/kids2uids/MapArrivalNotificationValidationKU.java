...
import com.kewill.kcx.component.mapping.formats.uids.ics20.BodyArrivalNotificationValidationUids;
 ...
 * Description	: Mapping of ICSArrivalNotificationValidation from KIDS to UIDS format.
 * 				: (IE348)
 * 
 * @author iwaniuk
 * @version 2.0.00
...
//          uidsHeader.writeHeader();
            ...
            Utils.log("ICS ArrivalNotificationValidation kids2uids = " + xmlOutputString.toString());
