...
import com.kewill.kcx.component.mapping.formats.uids.ics20.BodyEntrySummaryDeclarationUids;
 ...
 * Description	: Mapping of KIDS-ICSEntrySummaryDeclaration into UIDS-ICSDeclaration.
 * 				: (IE315)
 * 
 * @author  iwaniuk
 * @version 2.0.00
...
//          uidsHeader.writeHeader();
            ...
            Utils.log("ICS EntrySummaryDeclaration kids2uids = " + xmlOutputString.toString());
