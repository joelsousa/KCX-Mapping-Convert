...
import com.kewill.kcx.component.mapping.formats.uids.ics20.BodyEntryReleaseUids;
 ...
 * Description	: Mapping of ICSEntryRelease  from KIDS to UIDS.
 *              : (IE330)
 * 
 * @author iwaniuk
 * @version 2.0.00
...
//          uidsHeader.writeHeader();
            ...
            Utils.log("ICS EntryRelease kids2uids = " + xmlOutputString.toString());
