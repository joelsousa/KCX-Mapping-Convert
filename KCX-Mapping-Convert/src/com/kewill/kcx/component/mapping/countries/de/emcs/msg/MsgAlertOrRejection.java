...
public class MsgAlertOrRejection extends KCXMessage {
	...
	private StringList alertOrRejectionReasons;   	
	...
	public void startElement(Enum tag, String value, Attributes attr) {
	    if (value == null) {
			...
			case AlertOrRejectionReasons:
				alertOrRejectionReasons = new StringList(getScanner());
	...
	public StringList getAlertOrRejectionReasons() {
		return alertOrRejectionReasons;	
	}
	public void setAlertOrRejectionReasons(StringList argument) {
		this.alertOrRejectionReasons = argument;
	}
