...
/**
 * Modul		: MapDiversionRequestAcknowledgmentKK<br>
 * Erstellt		: 15.06.2010<br>
 * Beschreibung	: Mapping of KIDS-Format into KIDS-Format of DiversionRequestAcknowledgment message.
 *
 * @author  Pete T
 * @version 1.0.00
 */
public class MapDiversionRequestAcknowledgmentKK extends KidsMessage {
	...
	public String getMessage() {
        ...
        try {
            ...
            Utils.log("ICS DiversionRequestAcknowledgment KidsMessage = " + xmlOutputString.toString());
