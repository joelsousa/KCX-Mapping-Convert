...
public class MapLocalAppResultCK extends KidsMessageCY {
	...
	public MapLocalAppResultCK(XMLEventReader parser, KidsHeader kidsHeader, String encoding,
												   CyprusHeader cyprusHeader) throws XMLStreamException {
		msgCyprus = new MsgCD917B(parser);
		this.encoding = encoding;
		this.kidsHeader = kidsHeader;	
		if (cyprusHeader != null) {
			date = cyprusHeader.getDatOfPreMES9();
			time = cyprusHeader.getTimOfPreMES10();
		} 
	}
