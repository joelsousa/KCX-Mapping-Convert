 ...
 * Description	: Mapping of KIDS-Format into KIDS-Format of ControlNotification message.
 * 
 * @author iwaniuk
 * @version 2.1.00
 */
public class MapControlNotificationKK extends KidsMessage {
	private BodyExpControlNotificationKids 	body   = null;
	private MsgControlNotification message;

	public MapControlNotificationKK(XMLEventReader parser, String encoding) throws XMLStreamException {
	...
	public String getMessage() {
		...
		try {
			...
			body       = new BodyExpControlNotificationKids(writer);
