...
public class GoodsItemShort extends KCXMessage {
	...
	private Text                 motivation;   //EI20110204: new for IE322
    ...
    public GoodsItemShort(XmlMsgScanner scanner, String name) {
  		super(scanner);
  		msgName = name;
  	} 
    
    public GoodsItemShort(XmlMsgScanner scanner, String name, String type) {
  		super(scanner);
  		msgName = name;
  		msgType = type;
  	} 
