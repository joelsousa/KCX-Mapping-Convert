 ...
 * Description : transformer to convert UIDS-Format to KIDS messages
 *             : 
 * Parameters  : 
...
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpAmdUK;
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpCanUK;
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpConUK;
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpDatUK;
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpEntUK;
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpErlUK;
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpExtUK;
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpFupUK;
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpIndUK;
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpNckUK;
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpRelUK;
import com.kewill.kcx.component.mapping.countries.de.aes.uids2kids.MapExpStaUK;
...
/**
 * Transformer called to convert UIDS-Format to KIDS messages.
 * @author kron
 * @version 1.0.00
 */
public class UidsToKidsExport {
	...
	public String readUids(XMLEventReader parser, String encoding, UidsHeader uidsHeader, 
        ...
        switch (EUidsMessages.valueOf(msg)) {
            ...
            case InternalStatusInformation:
                ...
                prepareMessage(uidsHeader, kidsHeader, mapExpNckUK, commonFieldsDTO, 
       		...
       		case ErrorInformation:
                ...
                prepareMessage(uidsHeader, kidsHeader, mapErrInfUK, commonFieldsDTO, 
                                                                                "ErrorMessage", direction);
         	    mapErrInfUK.getMessage(writer);
         	    break;
       		case Confirmation:  
       			MapExpConUK mapExpConUK = new MapExpConUK(parser, kidsHeader, encoding);
                prepareMessage(uidsHeader, kidsHeader, mapExpConUK, commonFieldsDTO, 
       		...
       		case Cancelation:  
                ...
                prepareMessage(uidsHeader, kidsHeader, mapExpCanUK, commonFieldsDTO, 
       		...
       		case ExportDeclarationResponse:  
                ...
                prepareMessage(uidsHeader, kidsHeader, mapExpStaUK, commonFieldsDTO, 
                                                                         "DeclarationResponse", direction);
