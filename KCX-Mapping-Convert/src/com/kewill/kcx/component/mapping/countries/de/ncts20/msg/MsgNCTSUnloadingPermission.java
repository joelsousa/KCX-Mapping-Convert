...
/**
 * Module		: NCTS<br>.
 * Created		: 31.01.2013<br>
 * Description	: MsgNCTSUnloadingPermission
 * 
 * @author iwaniuk
 * @version 4.1.00
 */
...
public class MsgNCTSUnloadingPermission extends KCXMessage {
	...
	private String				carnetID;                //EI20130325
	...
	public PartyNCTS getDestinationTrader() {
		if (destinationTraderTIN != null) {
			if (destinationTrader == null) {
				destinationTrader = new PartyNCTS();
			}
			destinationTrader.setPartyTIN(destinationTraderTIN);
		}
	...
	public void setCarnetID(String value) {
		this.carnetID = value;
	}
}
