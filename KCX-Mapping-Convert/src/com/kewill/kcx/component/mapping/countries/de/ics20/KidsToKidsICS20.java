...
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapEntryDetailsDataKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapAdvanceInterventionNotKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapDiversionRequestRejectedKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapEntryReleaseKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapEntrySummaryDeclarationAmendmentAcceptanceKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapEntrySummaryDeclarationRejectedKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapImportControlDecisionKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapArrivalItemRejectionKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapArrivalNotificationKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapArrivalNotificationValidationKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapDeclarationAmendmentKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapDiversionRequestAcknowledgmentKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapDiversionRequestKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapEntryReleaseRejectionKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapEntrySummaryDeclarationAcknowledgmentKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapEntrySummaryDeclarationAmendmentRejectionKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapEntrySummaryDeclarationKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapExitSummaryDeclarationKK;
import com.kewill.kcx.component.mapping.countries.de.ics20.kids2kids.MapExitDeclarationAcknowledgmentKK;
 ...
 *
 * @author krzoska   copy from ICS10
 * @version 2.0.00
 */
public class KidsToKidsICS20 {
    ...
    public String readKids(XMLEventReader parser, KidsHeader kidsHeader,
        ...
        switch (EKidsICSMessages.valueOf(msg)) {
        	...
        	case ICSExitDeclarationAcknowledgment:
        		MapExitDeclarationAcknowledgmentKK mapExitDeclarationAcknowledgmentKK =
        			new MapExitDeclarationAcknowledgmentKK(parser, encoding);
        		mapExitDeclarationAcknowledgmentKK.setKidsHeader(kidsHeader);
        		mapExitDeclarationAcknowledgmentKK.setCommonFieldsDTO(commonFieldsDTO);
        		xml = mapExitDeclarationAcknowledgmentKK.getMessage();
        		break;        	
        		
        	case ICSExitSummaryDeclaration: 
        		MapExitSummaryDeclarationKK mapExitSummaryDeclarationKK =
        			new MapExitSummaryDeclarationKK(parser, encoding);
        		mapExitSummaryDeclarationKK.setKidsHeader(kidsHeader);
        		mapExitSummaryDeclarationKK.setCommonFieldsDTO(commonFieldsDTO);
        		xml = mapExitSummaryDeclarationKK.getMessage();
        		break;        	
