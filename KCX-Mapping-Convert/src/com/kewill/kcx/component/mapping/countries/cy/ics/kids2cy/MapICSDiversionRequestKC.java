...
/**
 * Module 		: 	MapICSDiversionRequestKC<br>
 ...
 * @version 1.0.00
 */
public class MapICSDiversionRequestKC extends CyprusMessage {

	private MsgDiversionRequest msgKids;

	public MapICSDiversionRequestKC(XMLEventReader parser, String encoding)
	...
	private void writeBody() {		            
		...
		//EI: writeCusoffent730323(msgKids.getActualOfficeOfFirstEntry());
		writeCusOffEntry323(msgKids.getDeclaredOfficeOfFirstEntry(), "323");  //EI20110714
