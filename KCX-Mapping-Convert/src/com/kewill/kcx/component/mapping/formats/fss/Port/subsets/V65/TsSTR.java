...
public class TsSTR extends Teilsatz {
	 ...
	 private String from  	= "";	 // 
	 private String art1  	= "";	 // Art der Rückmeldung, ZAPP immer 4 =  Auftragsrückmeldung
    ...
    public void setArt1(String argument) {
    	this.art1 = Utils.checkNull(argument);
    }  
