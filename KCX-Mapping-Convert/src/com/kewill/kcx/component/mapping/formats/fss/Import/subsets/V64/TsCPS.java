 ...
 * Erstellt             :       13.09.2011
 * Beschreibung 		:       Positionssatz des Abgabenbescheids
...
public class TsCPS extends Teilsatz {
    ...
    private String mittei		 = "";	 // Mitteilung an den Teilnehmer (Beschau)
    ...
    public String getMittei() {
    	 return mittei;
    }


    public void setMittei(String mittei) {
    	this.mittei = Utils.checkNull(mittei);
    }
    ...
    public boolean isEmpty() {
	  return  Utils.isStringEmpty(mittei) &&
    	Utils.isStringEmpty(nachw) &&
