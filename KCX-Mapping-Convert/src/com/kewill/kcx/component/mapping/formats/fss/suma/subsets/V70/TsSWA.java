...
public class TsSWA extends Teilsatz {
	...
	public boolean isEmpty() {
		return (Utils.isStringEmpty(regnr) && Utils.isStringEmpty(name1) &&
			...
			Utils.isStringEmpty(eori) && Utils.isStringEmpty(nl));					
	}
	...
	public void setEori(String eori) {
		this.eori = Utils.checkNull(eori);
	}

	public String getNl() {
		return nl;
	}
	public void setNl(String kzawb) {
		this.nl = Utils.checkNull(kzawb);
	}
}
