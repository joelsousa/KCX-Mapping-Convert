...
public class MsgEZA extends FssMessage {
	...
	private List<TsERC> ercList;  // Container 
	...
	public void setBeteiligterFuerRechnung(TsADR argument) {
		this.beteiligterFuerRechnung = argument;
	}
	...
	public String getFssString(String firstTs) throws FssException {		
		...
		if (kaeufer != null && !kaeufer.isEmpty()) {			//EI20130802: kaeufer hat gefehlt
		...
		if (txtList != null) {                     					 
			int txtSize = txtList.size();
			for (int j = 0; j < txtSize; j++) {
				TsTXT txt = (TsTXT) txtList.get(j);
