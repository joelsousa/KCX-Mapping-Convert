package com.kewill.kcx.component.mapping.formats.fss.Port.messages.V70;
 ...
 * 				: V70 new: TsHead, TsAKR, TsACR, TsAED
 * 
 * @author iwaniuk
 * @version 7.0.00
 */
    ...
    private String getPorPos(PorPos ebene, int nr) throws FssException {
		...
		//nur ebene2: 
			if (ebene.getAEData() != null && !ebene.getAEData().isEmpty()) {
				...
				if (ebene.getAEData().getADR3Subset() != null && !ebene.getAEData().getADR3Subset().isEmpty()) {	 
					ret = appendString(ret, ebene.getAEData().getADR3Subset().teilsatzBilden());	
				}
				if (ebene.getAEData().getADR4Subset() != null && !ebene.getAEData().getADR4Subset().isEmpty()) {	 
					ret = appendString(ret, ebene.getAEData().getADR4Subset().teilsatzBilden());	
				}
