...
/**
 * Module		: BodyEntrySummaryDeclarationKids.<br>
 * Date Started	: November 5, 2010<br>
 * 
 * @author Lassiter Caviles
 * @version 1.0.00
 *
 */
public class BodyEntrySummaryDeclarationKids extends KidsMessageICS {
        ...
        try {
            ...
            openElement("GoodsDeclaration"); 
              ...
              //EI20130704: zukuenftig wird NL auch ICS machen, aus DXB -> AEDXB, AMS->NLAMS
                ...
                //EI201101015: writeDateTimeToString("DeclarationTime", message.getDeclarationTime());
                ...
                writeElement("DeclarationPlace", message.getDeclarationPlace());                    	
                 ...
                 //EI20110105: writeDateTimeToString("DeclaredDateOfArrival", message.getDeclaredDateOfArrival());
