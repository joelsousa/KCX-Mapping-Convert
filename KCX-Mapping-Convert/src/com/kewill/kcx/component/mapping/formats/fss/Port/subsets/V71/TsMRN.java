...
public class TsMRN extends Teilsatz {
	 ...
	 private String mrnapa  = "";	 // BHT Pachstückanzahl aus der AES    EI20131007
	 private String abtnr  = "";	 // ZAPP ATB-Nr. der summar. Anmeldung (nur bei DUX)    EI20131007
    ...
    public String getMrnapa() {
		return mrnapa;
	}
	public void setMrnapa(String mrnapa) {
		this.mrnapa = Utils.checkNull(mrnapa);
	}
	...
	public void setAbtnr(String abtnr) {
		this.abtnr = Utils.checkNull(abtnr);
	}
