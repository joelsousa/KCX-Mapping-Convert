 ...
 * Beschreibung	: KFF JobInformation. Ist das gleiche wie MsgJOB aber mit scanner nicht parser
 * 
 * @author iwaniuk
 * @version 1.0.00
 */

public class JobInformation extends KCXMessage {
	...
	private String shpType = "";
	 ...
	 public JobInformation(XmlMsgScanner scanner) {
 		super(scanner);
	 }
