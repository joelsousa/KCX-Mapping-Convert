...
public class TsEDA extends Teilsatz {
    ...
    private String dtzoan  = "";      // TIN des Anmelders ist dt. Zollnummer; in V6 is in DAT
    ...
    private static String bcktax  = "0";      // Kennzeichen Ausfuhrerstattung konstant wg. FSS Abwärtskompatibilitaet  
	...
	public void setDtzoan(String argument) {
		this.dtzoan = Utils.checkNull(argument);
	}	
