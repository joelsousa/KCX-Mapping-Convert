...
public class TsEAM extends Teilsatz {
	...
	public void setEAMSubset(MsgExpEnt msgExpEnt) {		
		TransportMeans transportInland = null;
		TransportMeans transportBorder = null;
		Business business = null;
		IncoTerms incoTerms = null; 
		
		if (Utils.isStringEmpty(msgExpEnt.getReferenceNumber())) return;
		
		transportBorder = msgExpEnt.getTransportBorder();
		transportInland = msgExpEnt.getTransportInland();
		business = msgExpEnt.getBusiness();
