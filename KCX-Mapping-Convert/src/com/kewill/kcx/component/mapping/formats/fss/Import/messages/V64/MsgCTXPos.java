...
public class MsgCTXPos extends FssMessage{
	...
	private List <TsAHICTX> ahiList;      // Abzüge / Hinzurechnungen 
	...
	public void setAHIList(List <TsAHICTX> list) {
		ahiList = list;
    }
	public List <TsAHICTX> getAHIList() {
		return ahiList;
	}
	public void addAHIList(TsAHICTX subset) {
		if (ahiList == null) {
			ahiList = new Vector<TsAHICTX>();
		}
		ahiList.add(subset);
    }
