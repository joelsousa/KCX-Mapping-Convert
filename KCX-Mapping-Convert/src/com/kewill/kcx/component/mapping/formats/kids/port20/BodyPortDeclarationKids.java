package com.kewill.kcx.component.mapping.formats.kids.port20;
...
import com.kewill.kcx.component.mapping.formats.kids.common.KidsMessagePortGpo20;
 ...
 *
 */
public class BodyPortDeclarationKids extends KidsMessagePortGpo20 {
    ...
    public void writeBody(boolean isBDP) {
        try {
            ...
            openElement("GoodsDeclaration"); 
                ...
                if (isBDP) {   //EI20130508
                	if (message.getContainerDetailsList() != null) {                	 
                		for (Container container : message.getContainerDetailsList()) {
