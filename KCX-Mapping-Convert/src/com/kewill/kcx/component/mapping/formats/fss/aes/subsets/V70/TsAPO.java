...
public class TsAPO  extends Teilsatz {
    ...
    private String ahrico  = "";      // EI20130719:  Kennzeichen AH-stat Wert
	...
	public String teilsatzBilden() {
        ...
        buff = buff.append(trenner);       
        buff = buff.append(asvfr);   // CK20120828 asvfr eingefügt
        buff = buff.append(trenner);
        ...
        buff = buff.append(trenner);
        if (ahrico != null && ahrico.equals("1")) {  //wegen AES22, ist aber keine neue FSS-Version, solange nicht an
	...
	public boolean isEmpty() {
		return Utils.isStringEmpty(artnr)  && Utils.isStringEmpty(tnr) && Utils.isStringEmpty(tnrtrc) &&
		  ...
		  Utils.isStringEmpty(libort) && Utils.isStringEmpty(kzh2o) && Utils.isStringEmpty(ahrico);		
	}
