...
public class KexHeader extends UidsMessage {
    ...
    public KexHeader(XMLStreamWriter writer) {
        this.writer = writer;       
    }
            ...
            switch(event.getEventType()) {
               ...
               if (text == null || text.equals("")) {
            	   event = parser.nextEvent();
                    ...
                    switch(EKexHeaderTags.valueOf(text)) {
                		case shheader:
                    		event = parser.nextEvent();
                    	break;
                ...
                case XMLStreamConstants.END_ELEMENT:
                    ...
                    text = qname.getLocalPart();
                    Utils.log("(KexHeader END_ELEMENT: " + text);
                    //if (text.equals("CUST-MSG-ACTION")) {
                    if (text.equals("shheader")) {
                    	break parserloop;
                    }
                default: break;
            } // end switch
